...
with tab_register:
    ...
    if st.button("✅ 教科書情報を登録", type="primary", use_container_width=True):
        ...
        st.success(f"🎉 {subject_name}（{genre_name}）の教科書情報を登録しました！")
        st.info("⚠️ 本番反映するには data/ フォルダを GitHub に push してください")
...
st.markdown("---")
st.caption("🌟 RIA | 教科書登録システム v2.0（ジャンル対応）")
